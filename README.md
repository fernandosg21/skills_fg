...
| Skill | Descrição |
|-------|-----------|
| [`agente-atendimento-whatsapp`](./agente-atendimento-whatsapp) | Implementa ou audita atendimento autônomo no WhatsApp com contratos portáveis: inbox/outbox, idempotência e reconciliação, locks separados, gates frescos, anti-eco, grounding de preços e compromissos, privacidade e opt-out, deadline de LLM, testes concorrentes e rollout shadow para piloto. Inclui adapters de domínio/runtime e treino de voz opcional com retenção e revisão. |
